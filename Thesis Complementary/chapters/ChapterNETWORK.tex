...
%\begin{figure}
 %   \centering
  %  \subfigure[]{\includegraphics[width=0.45\textwidth]{figures/Networks/Video/Graph_Infection_0_Infected___manual.png}} 
   % \subfigure[]{\includegraphics[width=0.45\textwidth]{figures/Networks/Video/Graph_Infection_30_Infected___manual.png}} 
    %\subfigure[]{\includegraphics[width=0.45\textwidth]{figures/Networks/Video/Graph_Infection_60_Infected___manual.png}}
    %\subfigure[]{\includegraphics[width=0.45\textwidth]{figures/Networks/Video/Graph_Infection_90_Infected___manual.png}}
